...
const styles = {
  ...
  leftPanel: {
    ...
    minHeight: "100vh",
    background:
      "linear-gradient(160deg, #fff5ef 0%, #fef9f6 50%, #f5f4f1 100%)",
  ...
  bgGlow2: {
    ...
    borderRadius: "50%",
    background:
      "radial-gradient(circle, rgba(255,170,0,.07) 0%, transparent 70%)",
    pointerEvents: "none",
  },
  grid: {
    position: "absolute",
  ...
  boxSub: { color: "#52525b", fontSize: ".92rem", marginBottom: "2rem" },
  progressRow: { display: "flex", gap: 6, marginBottom: "2rem" },
  progressBar: (active) => ({
    flex: 1,
    height: 3,
    borderRadius: 2,
    background: active ? "#ff5c1a" : "rgba(0,0,0,0.12)",
      ...
      <div style={styles.leftPanel}>
        ...
        <div style={styles.leftContent}>
          ...
          <h1 style={styles.headline}>
            Your safety net
            <br />
            on <span style={{ color: "#ff5c1a" }}>every ride</span>
          </h1>
          <p style={styles.desc}>
            AI-powered income protection for delivery riders. When disruptions
            stop you from riding, we compensate you automatically.
          </p>
          <div style={styles.checkList}>
            {[
              {
                title: "Zero paperwork claims",
                desc: "Automatic payouts when disruptions hit your zone",
              },
              {
                title: "Real-time monitoring",
                desc: "AI tracks weather, traffic, and civil events every 15 minutes",
              },
              {
                title: "Affordable coverage",
                desc: "Starting at just ₹70 per week with UPI AutoPay",
              },
            ].map(({ title, desc }) => (
      ...
      <div style={styles.rightPanel}>
        <div style={styles.box}>
          ...
          <div style={styles.progressRow}>
            {[1, 2, 3].map((n) => (
              <div key={n} style={styles.progressBar(step >= n)} />
            ))}
          </div>
          ...
          <div style={styles.card}>
            {step === 1 && (
              <div style={{ display: "flex", flexDirection: "column", gap: 0 }}>
                ...
                {!otpSent ? (
                  <button style={styles.btnPrimary} onClick={sendOtp}>
                    Send OTP →
                  </button>
                ) : (
                  <>
                    ...
                    <button style={styles.btnPrimary} onClick={verifyOtp}>
                      Verify & Continue →
                    </button>
                  </>
                )}
            ...
            {step === 3 && zoneData && (
              <div style={{ display: "flex", flexDirection: "column" }}>
                <div style={styles.premiumBox}>
                  ...
                  >
                    Auto-deducted every Monday via UPI
                  </div>
                </div>
